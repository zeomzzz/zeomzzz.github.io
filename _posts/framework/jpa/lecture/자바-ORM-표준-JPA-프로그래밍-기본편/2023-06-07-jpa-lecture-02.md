...
- 화면에 설정 정보 입력
    ...
    - 서버 모드 / 사용자명 sa / 비밀번호 입력 X &rarr; 연결
...
> 
> - javax.persistence : JPA 표준 속성 &rarr; hibernate 외의 JPA 구현 라이브러리 사용 가능
> - hibernate : hibernate 전용 속성 &rarr; 다른 라이브러리 사용하면 변경 필요
...
- JPA는 특정 데이터베이스에 종속 X &rarr; 다른 데이터베이스로 변경 용이
...
- 회원 등록
    ...
    - 실행 결과 &rarr; JPA가 매핑 정보를 보고 추가해줌
